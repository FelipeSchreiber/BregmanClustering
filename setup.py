...
install_requires=["torchvision","torch_geometric","rpy2==3.5.1","scikit-learn==1.2.2","numpy==1.24.2","scipy==1.10.1","matplotlib","joblib~=1.1.0","networkx",\
                 "umap-learn","igraph","find-julia"],
author_email='felipesc@cos.ufrj.br',
packages=find_packages(),
cmdclass={'build_py': build_py,"install":OverrideInstall},
package_data = {'BregmanTests': ['*.r',"*.sh"]},
zip_safe=False)
#install_requires=["torch_geometric","rpy2","scikit-learn==1.2.2","numpy==1.24.2","scipy==1.10.1","matplotlib","joblib~=1.1.0"],
