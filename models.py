...
from divergences import euclidean
...
class BregmanGraphPartitioning( BaseEstimator, ClusterMixin ):
    ...
    def __init__( self, n_clusters, divergence = divergences.kullbackLeibler_binaryMatrix, 
    ...
    def singleNodeAssignment( self, X, node ):
        ...
        for k in range( self.n_clusters ):
            ...
            L[ k ] = divergences.kullbackLeibler_binaryMatrix( X, M )
            #print( L[k] )
        return np.argmin( L )
...
class BregmanNodeAttributeGraphClustering( BaseEstimator, ClusterMixin ):
    def __init__( self, n_clusters, 
                 graph_divergence = divergences.kullbackLeibler_binaryMatrix, attribute_divergence = euclidean, 
